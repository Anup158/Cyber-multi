      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <div>
          ...
          <p className="text-sm text-foreground/70">
            Upload an image. We estimate entropy to flag potential hidden
            payloads.
          </p>
        </div>
        <Card className="border-border/60">
          ...
          >
            ...
            {result && (
              ...
              >
                Risk: {risk} — Entropy {result.entropy.toFixed(2)} bits per
                pixel — {result.name}
              </div>
            )}
            <p className="text-xs text-foreground/60">
              Entropy alone cannot confirm steganography; use alongside
              format-specific detectors for accuracy.
            </p>
          </CardContent>
        </Card>
